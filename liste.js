...
app.get('/books', function(req, res, next) {
	...
	console.log(results);
	res.render("livres_liste", {'livres': results});
	})
});
...
app.post('/books/pret/:id', function(req, res, next)
	{
		console.log('pret ajouter avec succès...');
		app.db.collection("livres").update(req.params.id, {pret : {name : req.body.nom, date : req.body.datePret}});
